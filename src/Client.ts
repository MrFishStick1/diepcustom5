        ...
        switch (header) {
            ...
            case ServerBound.Input: {
                ...
                if (flags & InputFlags.levelup) {
                    ...
                    if ((this.accessLevel === config.AccessLevel.PublicAccess) || (camera.cameraData.values.level < config.maxPlayerLevel && ((this.game.arena.arenaData.values.flags & ArenaFlags.canUseCheats) || (this.accessLevel === config.AccessLevel.kReserved)))) {
                        this.setHasCheated(true);
